...
import com.xiaobai.core.utils.ConstantPropertiesUtil;
import com.xiaobai.core.utils.HttpClientUtils;
...
/**
 * @author xiaobai
 * @create 2021-08-12 23:34
 */
@Api(description = "微信接口管理")
...
public class WxApiController {
    ...
    public String genQrConnect(HttpSession session) {
        ...
        String state = "xiaobai";//为了让大家能够使用我搭建的外网的微信回调跳转服务器，这里填写你在ngrok的前置域名
